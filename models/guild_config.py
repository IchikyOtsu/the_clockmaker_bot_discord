...
class GuildConfig:
    ...
    plainte_support_role_ids:    list[str] = field(default_factory=list)   # rôles staff ajoutés aux threads de plainte
    ...
    def from_dict(cls, data: dict) -> GuildConfig:
        ...
        return cls(
            ...
            plainte_support_role_ids=[str(r) for r in cfg.get("plainte_support_role_ids", [])],
